...
class evior_post_trending_list extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Trending List', 'evior-extra' );
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .post-trending-list-wrap .post-grid-wrapper-two-inner .grid-thumbnail-two-wrap img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);		
    ...
    */
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-trending-list-wrap .post-grid-content-two h3.post-title',
           ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-trending-list-wrap .post-grid-content-two .post-excerpt-box p',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-trending-list-wrap .post-grid-content-two .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .post-trending-list-wrap .post-grid-content-two .post_grid_author_img',
			]
		 );
	...
	protected function render() {
		...
		<div class="news_post_trending_list post-trending-list-wrap">
			...
			<h2 class="trending-list-title"><?php echo esc_html($settings['trending_title']); ?></h2>
