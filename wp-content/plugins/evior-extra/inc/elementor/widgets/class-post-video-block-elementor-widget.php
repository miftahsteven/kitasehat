...
class evior_post_block_video extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Theme Video Blocks', 'evior-extra' );
	}
    ...
    */
    private function design_options() {
		...
		$this->start_controls_section(
            'design_option',
            [
                'label' => __( 'Typography', 'evior-extra' ),
                'tab' => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .video-box-wrapper .video-post-block-content h3.post-title',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .video-box-wrapper .video-post-block-content .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .video-box-wrapper .video-post-block-content .post_grid_author_img',
			]
		 );
	...
	protected function render() {
		...
		<div class="theme_post_videoblock__Column theme-post-video-blocks">
			<div class="row">
