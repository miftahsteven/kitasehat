...
class evior_post_videos_list extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video Posts List', 'evior-extra' );
	}
    ...
    */
    private function layout_options() {
		...
		$this->add_control(
			'video_list_title',
			[
				'label' => __( 'video List Title', 'plugin-domain' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .video-posts-list-wrap .post-grid-wrapper-two-inner .grid-thumbnail-two-wrap' => 'min-width: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .video-posts-list-wrap .post-grid-wrapper-two-inner .grid-thumbnail-two-wrap img' => 'height: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);			
    ...
    */
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .video-posts-list-wrap .post-grid-content-two h3.post-title',
           ]
        );	
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .video-posts-list-wrap .post-grid-content-two .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .video-posts-list-wrap .post-grid-content-two .post_grid_author_img',
			]
		 );
	...
	protected function render() {
		...
		<div class="news_post_trending_list post-trending-list-wrap video-posts-list-wrap">
		
			<h2 class="trending-list-title"><?php echo esc_html($settings['video_list_title']); ?></h2>
