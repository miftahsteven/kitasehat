...
class evior_post_grid_four extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Grid Style Four', 'evior-extra' );
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-post-grid-wrapper-four .news-post-grid-thumbnail img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);		
    ...
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .blog-post-grid-wrapper-four .news-post-grid-content h3',
           ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .blog-post-grid-wrapper-four .post-excerpt-box p',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .blog-post-grid-wrapper-four .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .blog-post-grid-wrapper-four .post_grid_author_img',
			]
		 );
