...
class evior_post_grid_slider extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Post Grid Slider', 'evior-extra' );
	}
		...
		$this->add_group_control(
		 ...
		 $this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .theme_post_grid__Slider .post-excerpt-box p',
           ]
        );	
