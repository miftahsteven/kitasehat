...
class evior_post_medium_list extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts List Medium', 'evior-extra' );
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .post-list-medium-wrap .post-grid-wrapper-two-inner .grid-thumbnail-two-wrap' => 'min-width: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .post-list-medium-wrap .post-grid-wrapper-two-inner .grid-thumbnail-two-wrap img' => 'height: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);		
    ...
    */
    private function meta_options() {
		...
		$this->add_control(
            'show_pagination',
            [
                'label' => __('Show Pagination', 'evior-extra'),
                'type' => \Elementor\Controls_Manager::SWITCHER,
                'label_on' => __('Show', 'evior-extra'),
                'label_off' => __('Hidden', 'evior-extra'),
                'return_value' => 'yes',
                'default' => 'no',
            ]
        );
    ...
    */
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-list-medium-style .post-grid-content-two h3.post-title',
           ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-list-medium-style .post-grid-content-two .post-excerpt-box p',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-list-medium-style .post-grid-content-two .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .post-list-medium-style .post-grid-content-two .post_grid_author_img',
			]
		 );
	...
	protected function render() {
		...
		<div class="news_post_trending_list post-trending-list-wrap post-list-medium-wrap post-list-medium-style">
		
        <?php while ($query->have_posts()) : $query->the_post(); ?>
		
				
				<div class="post-grid-wrapper-two-inner post-list-inner">
		...
		<?php 
			if ( 'yes' === $settings['show_pagination'] ) {
				...
				echo str_replace( "<ul class='page-numbers'>", '<ul class="page-pagination theme-widget-pagination-wrapp">', $return );
			}
