...
class evior_post_block extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Block Item', 'evior-extra' );
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px','%'],
				'selectors' => [
					'{{WRAPPER}} .blog-post-grid-wrapper .news-post-grid-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
        );
    ...
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-block-item .news-post-grid-content h3.post-title',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-block-item .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .post-block-item .post_grid_author_img',
			]
		 );
