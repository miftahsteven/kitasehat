...
class evior_post_grid extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Grid Item', 'evior-extra' );
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .blog-gridd-single-item .news-post-grid-thumbnail img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);		
		...
		$this->add_responsive_control(
			...
			[
                ...
                'size_units' => [ 'px','%'],
				'selectors' => [
					'{{WRAPPER}} .blog-gridd-single-item .news-post-grid-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}!important;',
				],
			]
        );
    ...
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .blog-gridd-single-item .news-post-grid-content h3.post-title',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .blog-post-grid-wrapper.blog-gridd-single-item .post-excerpt-box p',
           ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .blog-gridd-single-item .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .blog-gridd-single-item .post_grid_author_img',
			]
		 );
