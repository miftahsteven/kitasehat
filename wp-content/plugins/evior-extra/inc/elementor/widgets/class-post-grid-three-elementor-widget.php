...
class evior_post_grid_three extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Grid Style Three', 'evior-extra' );
	}
    ...
    */
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-grid-content-two h3.post-title',
           ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-grid-content-two .post-excerpt-box p',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-grid-content-two .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .post-grid-content-two .post_grid_author_img',
			]
		 );
	...
	protected function render() {
		...
		<div class="news_post_grid_design_two post-grid-wrapper-two post-grid-wrapper-three">
			<div class="row">
        ...
        <?php while ($query->have_posts()) : $query->the_post(); ?>
			...
			<div class="col-lg-3">
				...
				<div class="post-grid-wrapper-two-inner post-grid-wrapper-three-inner">
