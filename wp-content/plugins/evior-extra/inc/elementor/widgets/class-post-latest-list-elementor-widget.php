...
class evior_post_latest_list extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Recommended List', 'evior-extra' );
	}
    ...
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-recommended-list .post-grid-content-two h3.post-title',
           ]
        );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-recommended-list .post-grid-content-two .post-excerpt-box p',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .post-recommended-list .post-grid-content-two .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .post-recommended-list .post-grid-content-two .post_grid_author_img',
			]
		 );
