...
class evior_post_tab_two extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Evior Posts Tab Style 2', 'evior-extra' );
	}
    ...
    private function design_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .theme_post_Tab__content .theme_post_Tab__block.block-tab-item .blog-post-grid-wrapper .news-post-grid-thumbnail img' => 'height: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);	
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .theme_post_Tab__content .post-gridstyle-two.tab-bottom-grid-style .post-grid-wrapper-two-inner .grid-thumbnail-two-wrap img' => 'height: {{SIZE}}{{UNIT}}!important;',
				],
			]
		);	
        ...
        $this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .theme_post_Tab__block .blog-post-grid-wrapper .news-post-grid-content h3.post-title',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .post-gridstyle-two.tab-bottom-grid-style .post-grid-content-two h3.post-title',
			]
		);
