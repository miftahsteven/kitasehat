...
class evior_post_news_blockk extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts News Block 1', 'evior-extra' );
	}
    ...
    private function layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .news-block__One .news-post-grid-thumbnail img' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);		
    ...
    private function design_options() {
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .news-block__One .news-post-grid-content h3.post-title',
           ]
        );		
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .news-block__One .post-meta-items div',
           ]
        );
		...
		$this->add_group_control(
			...
			[
			   ...
			   'selector' => '{{WRAPPER}} .news-block__One .post-meta-items div.news-author-box',
			]
		 );
		...
		$this->add_group_control(
           ...
           [
              ...
              'selector' => '{{WRAPPER}} .news-block__One .post-excerpt-box p',
           ]
        );	
				...
				<div class="news-post-grid-content grid-content-bottom">
					...
					<div class="post-meta-items">
						...
						<div class="news-author-box">
							By: <?php printf('<a href="%1$s">%2$s</a>',
