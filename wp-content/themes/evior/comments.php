...
<div id="comments" class="blog-post-comment">
		...
		<?php if ( get_comment_pages_count() > 1 && get_option( 'page_comments' ) ) : ?>
			<nav id="comment-nav-above" class="navigation comment-navigation" role="navigation">
				...
				<div class="nav-previous">
					<?php previous_comments_link( esc_html__( '&larr; Older Comments', 'evior' ) ); ?>
				</div>
				<div class="nav-next">
					<?php next_comments_link( esc_html__( 'Newer Comments &rarr;', 'evior' ) ); ?>
				</div>
	...
	$defaults = [
		...
		'label_submit'		 => esc_html__( 'Post Comment', 'evior' ),
		'format'			 => 'xhtml',
	];
